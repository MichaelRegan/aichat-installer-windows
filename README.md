...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/michaelregan/aichat-installer-windows/master/Install-AIChat.ps1" -OutFile "$env:TEMP\Install-AIChat.ps1"
